...
function setup()
  -- Dashly tuning: MVP cycling routes should prefer safer rideable ways over fastest roads.
  -- Keep speeds recreational; race pacing belongs in app analytics, not routing graph.
  ...
  return {
    properties = {
      ...
      max_speed_for_map_matching    = 40/3.6, -- kmph -> m/s, bicycle-realistic for later /match
    ...
    -- Dashly tuning: stronger penalties for unsafe roads; cycleways/residential win.
    -- Used by cyclability metric.
    unsafe_highway_list = {
      primary = 0.35,
      secondary = 0.55,
      tertiary = 0.75,
