...
function setup()
  -- Dashly tuning: running routes should prefer footways/paths/tracks over vehicle roads.
  -- Speeds are routing preference weights, not athlete pace prediction.
  local walking_speed = 6
  return {
    properties = {
      weight_name                   = 'duration',
      max_speed_for_map_matching    = 22/3.6, -- kmph -> m/s, realistic running ceiling for later /match
    ...
    surface_speeds = {
      asphalt =       walking_speed,
      concrete =      walking_speed,
      compacted =     walking_speed*0.9,
      fine_gravel =   walking_speed*0.8,
      gravel =        walking_speed*0.75,
      pebblestone =   walking_speed*0.75,
      grass =         walking_speed*0.7,
      dirt =          walking_speed*0.7,
      ground =        walking_speed*0.7,
